...
void SceneMain::init()
{
    ...
    _camera_position = _world_size * 0.5f - game.getScreenSize() * 0.5f;
    _player = new Player();
    _player->init();
...
void SceneMain::renderBackground()
{
    ...
    float start_grid_index_x_valid = start_grid_index_x < 0 ? 0 : start_grid_index_x > world_grid_count.x ? world_grid_count.x
                                                                                                          : start_grid_index_x;
    float start_grid_index_y_valid = start_grid_index_y < 0 ? 0 : start_grid_index_y > world_grid_count.y ? world_grid_count.y
                                                                                                          : start_grid_index_y;
    ...
    float end_grid_index_x_valid = end_grid_index_x < 0 ? 0 : end_grid_index_x > world_grid_count.x ? world_grid_count.x
                                                                                                    : end_grid_index_x;
    float end_grid_index_y_valid = end_grid_index_y < 0 ? 0 : end_grid_index_y > world_grid_count.y ? world_grid_count.y
                                                                                                    : end_grid_index_y;
